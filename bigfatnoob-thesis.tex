...
\student{George}{Mathew} % a full middle name
...
\thesistitle{Design Decision Optimization in Goal Models}
...
\newcommand{\boldm}[1]{$\bm{#1}$}
\usepackage{paralist}
\usepackage{enumitem}
\setlistdepth{9}
\usepackage{mdframed}
\newcommand*\pconsistent{\vcenter{\hbox{\includegraphics[scale=0.34]{Chapter-6/figs/para_consistent.png}}}}
...
\begin{spacing}{1}
 ...
 \addcontentsline{toc}{chapter}{\bibname} %\textorpdfstring and \uppercase needed due to hyperref package http://www.latex-community.org/forum/viewtopic.php?f=44&t=16601
 %\vspace{-0.5in}
